...
export default function BookmarkButton(props: {
  ...
  return (
    <button
      onClick={() => props.handleBookmark(props.media.id, isBookmarked)}
      className="group absolute right-2 top-2 flex h-8 w-8 items-center justify-center rounded-full bg-[#000000]/50 hover:bg-[#FFFFFF]"
    >
      {isBookmarked ? (
        <svg
          width="12"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="stroke-[#FFFFFF] group-hover:stroke-[#000000]"
        >
          <path
